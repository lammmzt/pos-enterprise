                    ...
                    <div class="relative">
                        ...
                        <div class="flex flex-col gap-2">
                            <div class="px-4 py-2 text-xs italic font-bold text-gray-600 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">
                                @if($isAntrean)
                                    <i class="mr-1 fa-solid fa-lock text-amber-500"></i> Akun Antrean (Terbatas)
                                @else
                ...
                @if($isAntrean)
                    <div class="flex gap-4 p-5 border bg-amber-50 border-amber-200 rounded-3xl dark:bg-amber-900/20 dark:border-amber-800/50">
                        ...
                        <div class="text-sm">
                            ...
                            <p class="text-amber-700 dark:text-amber-400">Profil akun dikunci sepenuhnya oleh sistem dan tidak dapat diedit untuk keperluan keamanan data.</p>
                        </div>
                    </div>
                @endif
                    ...
                    <form wire:submit.prevent="updateProfile" class="space-y-6">
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="text" wire:model="nama" {{ $isAntrean ? 'disabled readonly' : '' }} 
                                        class="w-full py-3.5 pl-12 pr-4 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl outline-none focus:ring-4 focus:ring-brand-red/10 focus:border-brand-red transition-all disabled:opacity-60 disabled:bg-gray-200 dark:disabled:bg-gray-700 disabled:cursor-not-allowed">
                                </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="text" wire:model="no_hp" {{ $isAntrean ? 'disabled readonly' : '' }} 
                                        class="w-full py-3.5 pl-12 pr-4 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl outline-none focus:ring-4 focus:ring-brand-red/10 focus:border-brand-red transition-all disabled:opacity-60 disabled:bg-gray-200 dark:disabled:bg-gray-700 disabled:cursor-not-allowed">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <textarea wire:model="alamat" {{ $isAntrean ? 'disabled readonly' : '' }} rows="3"
                                    class="w-full py-3.5 pl-12 pr-4 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl outline-none focus:ring-4 focus:ring-brand-red/10 focus:border-brand-red transition-all disabled:opacity-60 disabled:bg-gray-200 dark:disabled:bg-gray-700 disabled:cursor-not-allowed"></textarea>
                            </div>
                        </div>

                        {{-- Ganti Password & Tombol Simpan (HANYA MUNCUL JIKA BUKAN ANTREAN) --}}
                        @if(!$isAntrean)
